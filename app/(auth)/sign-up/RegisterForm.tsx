        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 p-12">
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600">
              Join our community of over 2,500+ members and discover the path to
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Learn from certified yoga teachers with years of experience
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  50+ weekly classes at times that fit your lifestyle
                </p>
              </div>
            </div>
