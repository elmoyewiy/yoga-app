        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 p-12">
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600">
              Continue your wellness journey with Serenity Yoga & Wellness
              Center.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Monitor your wellness journey and achievements
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Reserve your spot in your favorite classes
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Stay connected with fellow wellness seekers
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12">
            <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {/* Submit Button - Add your onClick handler here */}
                <Button
                  type="submit"
                  disabled={loading}
